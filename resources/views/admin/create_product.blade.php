        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title">Add Snacks</h4>
                    ...
                    <form action="/admin/add-product" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    CookingRecipe
                                    <textarea class="ckeditor form-control" name="inputCookingRecipe" id="inputCookingRecipe"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    Calories
                                    <input type="text" name="inputCalories" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (count($category)>0)
                                        @foreach ($category as $cate)
                                            {{$cate->ID_category}} -> {{$cate->NameCategory}}
                                            <br>
                                        @endforeach
                                    @endif
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    Information
                                    <textarea class="ckeditor form-control" name="inputIntroduce" id="inputIntroduce"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
