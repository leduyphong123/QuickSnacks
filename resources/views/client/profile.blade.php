                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">
                        <li class="breadcrumb-item" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a href="/" target="_self" itemprop="item"><span itemprop="name">Home Page</span></a>
        ...
        <div class="AccountContent">
            <div class="AccountList">
                <ul class="list-unstyled">
                    ...
                    <li class="last"><a href="/PurchaseHistory">Purchase History</a></li>
                    ...
                    <div class="row">
                        <div class="col-12" id="customer_sidebar">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                               ...
                               <h2 class="name_account" >{{$c->username}}</h2>

                                <a id="update_profile" href="/editprofile/{{$c->ID_user}}">Update information</a>
                            </div>
